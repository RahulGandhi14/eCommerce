                    ...
                    <Box mt={5}>
                        ...
                        <Grid container className="accountSection">
                            {windowWidth>599 ? (
                                ...
                                <Grid container direction="row" justify="space-between" className="mt10">
                                    <p 
                                        className={`cursorPointer ${currentTab==='profile' ? 'activeLink' : ''}`}
                                        onClick={()=>setCurrentTab("profile")}
                                    >Profile</p>
                                    ...
                                    >Addresses</p>
                                    <p
                                        className={`cursorPointer ${currentTab==='orders' ? 'activeLink' : ''}`}
                                        onClick={()=>setCurrentTab("orders")} 
                                    >Orders</p>
                                </Grid>
                            )}
                            <Grid item lg={10} md={10} sm={9} style={{width:"inherit"}}>
